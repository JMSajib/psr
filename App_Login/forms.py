...
class EditProfileForm(forms.ModelForm):
    uva = forms.URLField(label="Your Uva ID", required=False)    
    hacker_rank = forms.URLField(label="Your HackerRank ID", required=False)    
    codeforces = forms.URLField(label="Your Codeforces ID", required=False)
